<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学校" prop="school" :show-overflow-tooltip="true" width="150" />
    ...
    <el-dialog :title="title" :close-on-click-modal="false" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item v-if="schoolShow" label="选择学校"   prop="schoolId">
          <el-select v-model="form.schoolId" :disabled="title=='修改角色'?true:false" placeholder="请选择">
            <el-option
...
export default {
  ...
  created() {
    console.log(window.localStorage.getItem('schoolId'))
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.roleId != undefined) {
            ...
            // this.form.schoolId = Cookies.get("schoolId");
